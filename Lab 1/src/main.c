...
void print(mon_t res[], int n, int k, char *path); // вывод результата в файл
...
void run() {
    ...
    print(res, n, k1 * k2, SEQ_OUT_PATH);
    print(res, n, k1 * k2, PAR_OUT_PATH);
    free(p1);
    free(p2);
    free_pol(pol1, k1);
    free_pol(pol2, k2);
...
void print(mon_t res[], int n, int k, char *path) {
